...
DefaultWorkGroupInitialization::DefaultWorkGroupInitialization() {
    ...
    double mv_memory_limit = 0.2;
    auto default_mv_wg = std::make_shared<WorkGroup>("default_mv_wg", WorkGroup::DEFAULT_MV_WG_ID, WorkGroup::DEFAULT_MV_VERSION,
                                                     mv_cpu_limit, mv_memory_limit, 0, WorkGroupType::WG_DEFAULT);
